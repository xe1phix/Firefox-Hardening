...
## The User.js Project Github Page:
...
cd ~/Downloads/Scripts/user.js/


## Copy The user.js File into The Users Firefox Directory:
cp -v user.js /home/xe1phix/.mozilla/firefox/xk1uxyq9.Parrot/user.js
cp -v user.js ~/.mozilla/firefox/xk1uxyq9.Parrot/user.js
cp -v user.js /home/parrotkios/.mozilla/firefox/xk1uxyq9.Parrot/user.js
...
cat /usr/lib/firefox-esr/browser/defaults/preferences/firefox-esr.js
cat /usr/lib/firefox-esr/browser/defaults/preferences/firefox-esr.js | less
...
cp -v locked_user.js /usr/lib/firefox/browser/firefox.js
cp -v locked_user.js /usr/lib/parrot-skel/etc/skel/.mozilla/firefox/xk1uxyq9.Parrot/user.js
cp -v user.js /usr/lib/firefox-esr/browser/defaults/preferences/user.js
cp -v user.js /usr/lib/firefox/browser/defaults/preferences/user.js
